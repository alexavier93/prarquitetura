...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.projetos.index') }}"><i class="far fa-images"></i><span>Projetos</span></a>
            </li>

            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.categorias.index') }}"><i class="far fa-images"></i><span>Categorias</span></a>
            </li>
